class flipkart {
    ...
    constructor(page) {
        ...
        this.cloth=page.locator('//img[@src="https://rukminim1.flixcart.com/fk-p-flap/380/510/image/f63af45677b331e7.jpg?q=90"]')
    ...
    async func(url: string) {
        ...
        await this.page.screenshot({path:`screenshot/day20-task1-sc-${time}.png`})
    }
}
