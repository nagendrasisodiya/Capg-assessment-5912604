...
test("olympic-task", async({page})=>{
  ...
  await page.locator('//div[@class="search--results pb-5"]/descendant::a[@class="article--wrapper"]').click()
  ...
  await page.screenshot({path:`screenshot/day12-task1-sc-${time}.png`})
})